...
const PromptInput: React.FC<PromptInputProps> = ({ onSubmit, isProcessing, placeholder = "I would like to do a weekend trip hiking Yosemite on trails with fewer people." }) => {
